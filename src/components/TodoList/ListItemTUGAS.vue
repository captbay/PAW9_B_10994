  ...
  <v-main class="list">
    ...
    <v-card>
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="headline"
            >Delete Multiple</v-list-item-title
          >
        </v-list-item-content>
      </v-list-item>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Priority", value: "priority", filter: this.priorityFilter },
  ...
  methods: {
    priorityFilter(value) {
      ...
      // Check if the current loop value (The priority value)
      // equals to the selected value at the <v-select>.
      return value === this.priorityFilterValue;
    },
    save() {
